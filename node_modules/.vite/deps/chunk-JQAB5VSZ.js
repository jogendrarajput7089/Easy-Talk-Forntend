...
var MessageDeliveryReporter = class {
  ...
  trackDeliveredCandidate(collection) {
    var _a, _b;
    if (isChannel(collection) && !((_a = collection.getConfig()) == null ? void 0 : _a.read_events)) return;
    if (isThread(collection) && !((_b = collection.channel.getConfig()) == null ? void 0 : _b.read_events)) return;
  ...
  _handleChannelEvent(event) {
    ...
    switch (event.type) {
      ...
      case "user.watching.stop":
        if ((_h = event.user) == null ? void 0 : _h.id) {
      ...
      case "message.new":
        if (event.message) {
          const client = this.getClient();
          const ownMessage = ((_i = event.user) == null ? void 0 : _i.id) === ((_j = client.user) == null ? void 0 : _j.id);
          ...
          if ((_k = event.user) == null ? void 0 : _k.id) {
      ...
      case "channel.truncated":
        if ((_l = event.channel) == null ? void 0 : _l.truncated_at) {
      ...
      case "member.updated": {
        ...
        if (memberCopy == null ? void 0 : memberCopy.user) {
          ...
          if (((_m = channel.data) == null ? void 0 : _m.member_count) && event.type === "member.added") {
            channel.data.member_count += 1;
          }
        }
        const currentUserId = this.getClient().userID;
        if (typeof currentUserId === "string" && typeof ((_n = memberCopy == null ? void 0 : memberCopy.user) == null ? void 0 : _n.id) === "string" && memberCopy.user.id === currentUserId) {
          channelState.membership = memberCopy;
        }
        break;
      }
      case "member.removed":
        if ((_o = event.user) == null ? void 0 : _o.id) {
          const newMembers = {
            ...channelState.members
          };
          delete newMembers[event.user.id];
          channelState.members = newMembers;
          if ((_p = channel.data) == null ? void 0 : _p.member_count) {
...
//# sourceMappingURL=chunk-JQAB5VSZ.js.map
